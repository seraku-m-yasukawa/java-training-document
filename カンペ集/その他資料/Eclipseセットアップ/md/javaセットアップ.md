...
1. [JDK Builds from Oracle](https://jdk.java.net/)を開き、`JDK 1.8`を選択。
<img src="../img/JDK_01.png">

1. `Builds`の`Windouw/x64`の右にある`zip`を選択。ダウンロードされる。
<img src="../img/JDK_02.png">

1. ダウンロードしたjdkを解凍し、中身をどこかに配置する。
   ※ユーザフォルダ内に`.jdks`を作成し、その中に入れたりする
<img src="../img/JDK_03.png">

1. ファイルを配置したら、配置したフォルダのパスをコピーする。
<img src="../img/JDK_04.png">

1. javaの環境変数を設定するため、環境変数の設定画面を開く。
   ※検索すれば開ける
<img src="../img/JDK_05.png">

1. 下の`環境変数`を選択
<img src="../img/JDK_06.png">

1. 上の`新規`を選択
<img src="../img/JDK_07.png">

1. 環境変数`JAVA_HOME`を作成。
<img src="../img/JDK_08.png">

1. `Path`を選択して`編集`を選択。
<img src="../img/JDK_09.png">


1. `%JAVA_HOME%\bin`を追加する。
<img src="../img/JDK_10.png">
...
java --version
```
正しく設定できていれば、下記のようなメッセージが表示される。
```console
C:\Users\m-yasukawa>java --version
openjdk 11.0.10 2021-01-19
OpenJDK Runtime Environment AdoptOpenJDK (build 11.0.10+9)
OpenJDK 64-Bit Server VM AdoptOpenJDK (build 11.0.10+9, mixed mode)
```

もし下記のようなメッセージが表示された場合、どこかしらでミスっている。JAVA_HOMEの記述ミスがありがち。
```console
