...
## **手順**
1. Eclipseを開いていたら閉じる
1. Eclipseのショートカットが存在する場所を開く
1. ショートカットを右クリックしてプロパティ
1. リンク先を編集　最後に` -nl -ja`をつける  
<img src="../img/localizing_ja_01.png" width="40%"><div style="page-break-after:always"></div>
...
<img src="../img/localizing_ja_02.png" width="60%">

1. なんか出てくるけど名前は何でもいいです（わかりやすくbabelとかでいいと思います）  
<img src="../img/localizing_ja_03.png" width="60%"><div style="page-break-after:always"></div>

1. `I accept~`をチェックして`Finish`  
<img src="../img/localizing_ja_04.png" width="60%">
