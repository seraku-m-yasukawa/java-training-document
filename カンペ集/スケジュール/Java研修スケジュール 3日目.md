# Java研修スケジュール 3日目
講義内容の詳細は[別紙](3日目.html "3日目")に記載。

| タイムテーブル ||
| :--- | :--- |
| 09:30 - 11:00 | オブジェクト指向について |
| 11:00 - 11:10 | 休憩 兼 フォロー |
| 11:10 - 11:30 | javaの作り方 |
| 11:30 - 13:00 | クラスとインスタンス |
| 14:00 - 14:45 | カプセル化 |
| 14:45 - 15:30 | コンストラクタ |
| 15:30 - 18:00 | 課題 |
---
...
## オブジェクト指向について
- [オブジェクト指向](3日目.html#オブジェクト指向)～[オブジェクトについて](3日目.html#オブジェクトについて)
オブジェクト指向の考え方、javaにおいてのオブジェクトとは何かを例を見せながら解説し、実際にオブジェクトを考えてもらう。

### オブジェクトを作ってもらう
- [課題1](3日目.html#課題1)
  テキストでよいので、オブジェクトを考えてもらう。  
  コード化は今日の課題とする。



## javaの作り方
- [javaの作り方](3日目.html#javaの作り方)
  Eclipseのプロフェクトとパッケージについて解説、実際に作ってもらう。


## クラスとインスタンス
- [クラス](3日目.html#クラス)～[インスタンス](3日目.html#インスタンス)
  クラスとインスタンスについて解説する。


## カプセル化
- [カプセル化](3日目.html#カプセル化)
  カプセル化について解説する。


## コンストラクタ
- [コンストラクタ](3日目.html#コンストラクタ)
  コンストラクタについて解説する。
  カプセル化とコンストラクタは順序が逆でもいいかも。


## 課題
- [課題2](3日目.html#課題2)
  考えてもらったオブジェクトを実際にコードにしてもらう。
